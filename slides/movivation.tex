...
\begin{enumerate}
  ...
  \pause
  \begin{itemize}
    \item How does production-grade optimizers approach this? (XLA, TensorRT, TVM, etc.)
  ...
  \begin{itemize}
    \item Operator's performance characteristics are often associated by its kind
